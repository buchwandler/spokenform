...
_DIGIT_NAMES: dict[str, tuple[str, ...]] = {
    ...
    "kk": ("нөл", "бір", "екі", "үш", "төрт", "бес", "алты", "жеті", "сегіз", "тоғыз"),
...
_LETTER_NAMES: dict[str, Mapping[str, str]] = {
    ...
    "ar": {character: character for character in "abcdefghijklmnopqrstuvwxyz"},
    "he": {character: character for character in "abcdefghijklmnopqrstuvwxyz"},
    "kk": {character: character for character in "abcdefghijklmnopqrstuvwxyz"},
