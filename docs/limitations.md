...
- English, German, French, Spanish, Italian, Portuguese, Czech, Japanese, Korean, Swedish, Vietnamese, and Chinese have explicit runtime structured policies. Japanese, Korean, Swedish, Vietnamese, and Chinese runtime support is covered by focused regression tests, but it does not imply kokorog2p or PolyNorm parity.
