...
- Added Vietnamese runtime support for cardinal numbers, reviewed quantities, temperatures, and VND/₫ amounts

### Documentation

- Documented Vietnamese identifiers, numeric punctuation, dependency ownership, and fail-closed semantic boundaries

### Quality

- Added Vietnamese regression coverage for precision, grouping, mapping, protection, metadata, and sequence safety
