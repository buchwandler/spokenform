...
def test_ordinal_policies_validate_suffixes_and_degree_collisions() -> None:
    ...
    assert prepare("1nd 2rd 3th", language="en", use_spacy=False).spoken_text == (
        "1nd 2rd 3th"
    )
    ...
    assert prepare("das 3. Ergebnis; ihren 3. Versuch", language="de", use_spacy=False).spoken_text == (
        "das dritte Ergebnis; ihren dritten Versuch"
    )
