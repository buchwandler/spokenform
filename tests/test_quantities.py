...
def test_percentage_and_compound_units_are_claimed_as_whole_spans() -> None:
    ...
    assert prepare("2 mol/l", language="de", use_spacy=False).spoken_text == ("zwei Mol pro Liter")
...
def test_currency_symbols_use_guarded_locale_decimal_heuristics() -> None:
    ...
    assert prepare("150€", language="de", use_spacy=False).spoken_text == ("einhundertfünfzig Euro")
